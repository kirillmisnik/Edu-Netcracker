package edu.netcracker.tasks.task3;

import edu.netcracker.tasks.task3.address.Address;
import edu.netcracker.tasks.task3.person.Person;
import edu.netcracker.tasks.task3.phone.PhoneNumber;
import edu.netcracker.tasks.task3.shirt.Shirt;
import edu.netcracker.tasks.task3.sql.InstructionSQL;
